...
const DashBoardItem = ({ item }) => {
  const { poster } = item;
  return (
    <div className="h-80 w-[50%] bg-gray-400 rounded-md bg-clip-padding backdrop-filter backdrop-blur-xl bg-opacity-0 border-2 border-indigo-200 my-4 shadow-lg flex dark:border-gray-700">
